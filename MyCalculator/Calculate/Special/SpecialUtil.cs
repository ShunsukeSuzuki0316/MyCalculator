...
namespace MyCalculator
{
	public class SpecialUtil
	{
		...
		public static List<string> culcTypeList = new List<string>
			{   V.AdditionMark,
				V.SubtractionMark,
				V.MultiplicationMark,
				V.DivisionMark,
				V.ExponentiationMark };
		...
		public static Dictionary<string, string> typeConvertList = new Dictionary<string, string>()
			{   { "入力された値", JAN.Type_Input_Value },
				{ "定数", JAN.Type_Constant_Value },
				{ "前回の計算結果", JAN.Type_Previous_Culculate_Result_Value },
				{ "前ステップの最後の計算結果", JAN.Type_Last_Culculate_Result_Value } };

		public static List<string> realTypeList = new List<string>
			{   JAN.Type_Input_Value,
				JAN.Type_Constant_Value,
				JAN.Type_Previous_Culculate_Result_Value,
				JAN.Type_Last_Culculate_Result_Value };
